...
class _ChatScreenState extends State<ChatScreen> {
  ...
  String otherUserName = 'Chat'; // default AppBar title

  @override
  void initState() {
    super.initState();
    otherUserName = widget.otherUserName ?? 'Chat';
    if (widget.otherUserName == null) _loadOtherUserName();
    markMessagesAsRead();
  }
  ...
  void _loadOtherUserName() async {
    ...
    if (data['name'] != null && data['name'].toString().isNotEmpty) {
      ...
      name = data['username'];
    } else if (data['patientName'] != null && data['patientName'].toString().isNotEmpty) {
